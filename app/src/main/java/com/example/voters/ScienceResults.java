...
public class ScienceResults extends AppCompatActivity {
    ...
    private static final String TAG = "ScienceResults";
        ...
        presidentquery.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    adapter = new SchoolVotesAdapter(ScienceResults.this, list);
