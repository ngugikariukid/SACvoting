...
public class BusinessCandidates extends AppCompatActivity {
    ...
    private static final String TAG = "BusinessCandidates";
        ...
        presidentquery.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    adapter = new BusinessAdapter(BusinessCandidates.this, list);
