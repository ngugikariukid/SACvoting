...
public class TreasurerResults extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query presidentquery = reference.child("candidates").orderByChild("category").equalTo("Treasurer");
        presidentquery.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    adapter = new VotesAdapter(TreasurerResults.this, list);
