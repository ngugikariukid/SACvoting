...
public class PresidentResults extends AppCompatActivity {
    ...
    private static final String TAG = "PresidentResults";
        ...
        presidentquery.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    adapter = new VotesAdapter(PresidentResults.this, list);
